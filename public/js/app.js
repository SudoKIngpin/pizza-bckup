...
var addToCart = document.querySelectorAll(".add-to-cart"); //arry of all btns with same class ! 
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); // json string cnverted to JSON object
    updateCart(pizza);
    console.log(pizza);
